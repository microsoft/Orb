...
export class VstsClient {
    private baseURI = "https://msazure.visualstudio.com/defaultcollection/_apis/git/repositories/5232241e-cbc5-46eb-881b-fddc9218faa3";
    ...
    public getPullRequestURL(pullRequestId) {
        return "https://msazure.visualstudio.com/One/_git/Azure-OrbModels/pullrequest/{0}".format(pullRequestId);
    }
